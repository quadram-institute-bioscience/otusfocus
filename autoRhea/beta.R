...
if (length(args) != 5) {
  ...
  stop("Arguments: OTUTAB_NORMALIZED METADATA TREE CATEGORY OUTPUT_DIR.\n", call.=FALSE)
}

normalized_otutable = args[1]
...
if (!file.exists(normalized_otutable)){
  stop("Otutab file found\n")
}
if (!file.exists(metadata_file)){
  stop("metadata_file file found\n")
}
if (!file.exists(tree_file)){
  stop("tree_file file found\n")
}
