...
write.table(norm_otu_table,     "otutab-norm.tab",     sep = "\t", col.names = NA, quote = FALSE)

# Write the normalized table with taxonomy in a file
write.table(norm_otu_table_tax, "otutab-norm-tax.tab", sep = "\t", col.names = NA, quote = FALSE)

# Write the normalized relative abundance table in a file and copy in directory Serial-Group-Comparisons if existing
write.table(rel_otu_table,      "otutab-norm-rel.tab", sep = "\t",col.names = NA, quote = FALSE)
...
write.table(rel_otu_table_tax, "otutab-norm-rel-tax.tab", sep ="\t",col.names = NA, quote = FALSE)
